...
class Controller:
    ...
    def send_packet(self, packet=[0x00, 0x00, 0x08, 0x80, 0x80, 0x80, 0x80, 0x00], debug=False):
        if not debug:
            ...
            commandSuccess = (byte_in == RESP_USB_ACK or byte_in == RESP_UPDATE_ACK)
        else:
            commandSuccess = True
    ...
    def testbench_btn(self):
        ...
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(BTN_PLUS)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(BTN_MINUS)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(BTN_LCLICK)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(BTN_RCLICK)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
    ...
    def testbench_dpad(self):
        self.send_cmd(DPAD_U)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_R)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_D)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_L)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
    ...
    def testbench_dpad_diag(self):
        self.send_cmd(DPAD_U_R)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_D_R)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_D_L)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(DPAD_U_L)
        self.p_wait(0.5)
        self.send_cmd()
        self.p_wait(0.001)
    ...
    def testbench_lstick(self):
        ...
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(LSTICK_U)
        self.p_wait(0.5)
        self.send_cmd(LSTICK_R)
        self.p_wait(0.5)
        self.send_cmd(LSTICK_D)
        self.p_wait(0.5)
        self.send_cmd(LSTICK_L)
        self.p_wait(0.5)
        self.send_cmd(LSTICK_U)
        self.p_wait(0.5)
        self.send_cmd(LSTICK_CENTER)
        self.p_wait(0.5)
    ...
    def testbench_rstick(self):
        ...
        self.send_cmd()
        self.p_wait(0.001)
        self.send_cmd(RSTICK_U)
        self.p_wait(0.5)
        self.send_cmd(RSTICK_R)
        self.p_wait(0.5)
        self.send_cmd(RSTICK_D)
        self.p_wait(0.5)
        self.send_cmd(RSTICK_L)
        self.p_wait(0.5)
        self.send_cmd(RSTICK_U)
        self.p_wait(0.5)
        self.send_cmd(RSTICK_CENTER)
        self.p_wait(0.5)
